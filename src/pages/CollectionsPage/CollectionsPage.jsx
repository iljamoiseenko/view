  ...
  return (
    <div className="coll-page">
      <div className="container coll-page__inner">
        ...
        <div className="coll-page__split">
          {activeCuratedLists.length > 0 && (
            <div className="coll-page__curated">
              <h2 className="coll-page__section-title">{t('curated.badge')}</h2>
          ...
          <div className="coll-page__categories">
            <h2 className="coll-page__section-title">{t('collections.categoriesTitle')}</h2>
